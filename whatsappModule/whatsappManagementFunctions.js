              ...
              if (createWhatsappTextMessageResult.success){
                if (selectOrCreateActiveWhatsappConversationIDResult.result.whatsappConversationIsActive){
                  ...
                  [
                    {
                      whatsappConversationID: whatsappConversationID,
                      whatsappConversationAssignedAgentID: selectOrCreateActiveWhatsappConversationIDResult.whatsappConversationAssignedAgentID, 
                      whatsappConversationRecipientPhoneNumber: selectOrCreateActiveWhatsappConversationIDResult.whatsappConversationRecipientPhoneNumber,
                      whatsappConversationRecipientProfileName: selectOrCreateActiveWhatsappConversationIDResult.whatsappConversationRecipientProfileName,
                      whatsappConversationRecipientID: selectOrCreateActiveWhatsappConversationIDResult.selectWhatsappContactInformationResult.result.contactID,
                      whatsappConversationRecipientEmail: selectOrCreateActiveWhatsappConversationIDResult.selectWhatsappContactInformationResult.result.contactEmail,
                      whatsappConversationRecipientLocations: selectOrCreateActiveWhatsappConversationIDResult.selectWhatsappContactInformationResult.result.contactLocations,
                      whatsappConversationRecipientLocationDetails: selectOrCreateActiveWhatsappConversationIDResult.selectWhatsappContactInformationResult.result.contactLocationDetails,
                      whatsappConversationRecipientNote: selectOrCreateActiveWhatsappConversationIDResult.selectWhatsappContactInformationResult.result.contactNote,
                      whatsappConversationStartDateTime: selectOrCreateActiveWhatsappConversationIDResult.whatsappConversationStartDateTime,
                      whatsappConversationEndDateTime: selectOrCreateActiveWhatsappConversationIDResult.whatsappConversationEndDateTime,
                      whatsappConversationIsActive: selectOrCreateActiveWhatsappConversationIDResult.whatsappConversationIsActive,
                      whatsappGeneralMessageID: whatsappGeneralMessageID,
                      whatsappGeneralMessageIndex: whatsappGeneralMessageIndex,
